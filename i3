...
set $ws-web 2: Web
set $ws-code 3: Code
set $ws-slack 8: Slack
set $ws-mail 9: Mail
set $ws-term 10: Terminal

# switch to workspace
bindsym $mod+1 workspace 1
bindsym $mod+2 workspace $ws-web
bindsym $mod+3 workspace $ws-code
bindsym $mod+4 workspace 4
bindsym $mod+5 workspace 5
bindsym $mod+6 workspace 6
bindsym $mod+7 workspace 7
bindsym $mod+8 workspace $ws-slack
bindsym $mod+9 workspace $ws-mail
bindsym $mod+0 workspace $ws-term

# move focused container to workspace
bindsym $mod+Shift+1 move container to workspace 1
bindsym $mod+Shift+2 move container to workspace $ws-web
bindsym $mod+Shift+3 move container to workspace $ws-code
bindsym $mod+Shift+4 move container to workspace 4
bindsym $mod+Shift+5 move container to workspace 5
bindsym $mod+Shift+6 move container to workspace 6
bindsym $mod+Shift+7 move container to workspace 7
bindsym $mod+Shift+8 move container to workspace $ws-slack
bindsym $mod+Shift+9 move container to workspace $ws-mail
bindsym $mod+Shift+0 move container to workspace $ws-term
